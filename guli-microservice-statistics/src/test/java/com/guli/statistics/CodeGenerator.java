...
public class CodeGenerator {
	...
	public void genCode() {
		...
		dsc.setUrl("jdbc:mysql://192.168.180.130:3306/guli_" + moduleName + "_190105?characterEncoding=utf-8&useSSL=false");
		dsc.setDriverName("com.mysql.jdbc.Driver");
		dsc.setUsername("root");
		dsc.setPassword("Ce5dknB2y%*n");
